...
def write(images, overlay_image, boxes, prefix, folder='generate'):
    ...
    cv2.imwrite(f'{folder}/mask_table_line/{prefix}_vertical.png', images[TableCreator.TABLE_LINES_VERTICAL])
    cv2.imwrite(f'{folder}/mask_table_line/{prefix}_horizontal.png', images[TableCreator.TABLE_LINES_HORIZONTAL])
